...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahentaa_saldoa_oikein2(self):
        self.kortti.syo_edullisesti()
    ...
    def test_kortin_saldo_ei_ylita_maksimia(self):
        self.kortti.lataa_rahaa(9999999)
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_jos_vain_siihen_on_varaa(self):
    ...
    def test_kortilla_voi_ostaa_maukkaan_lounaan_jos_vain_siihen_on_varaa(self):
